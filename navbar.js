...
import { Link, NavLink } from "react-router-dom"; //Outlet, 
function Navbar(){
  return (
    <div className="flex flex-row items-center  justify-between px-20 py-10">
      <div className="flex flex-row items-center">
        <h1 className="font-bold italic text-2xl text-blue mr-10">Payments</h1>
        <ul className="flex flex-row space-x-10">
          {/*<li> {/*
          <Link to = {`/sagar/category/jewelery`} className="text-gray-400 text-sm tracking-wide font-light">HomePage</Link>*//*} </li> */}
          <li>
            <a
              href="#"
