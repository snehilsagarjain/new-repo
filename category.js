...
const Category = (props) => { //{data}, newcate
    var title = [], image = [], len = 0, count = 0, count1 = 0, last, last1, len1, myStyle;
    ...
    return( 
        ...
        props.data.map((list, index) => { 
            ...
            //console.log("arg="+props.newcate);
                ...
                if(list.category === id){ 
                    count = 0; count1 = 0;                     console.log("count count1");
        ...
        var child = ee.lastElementChild; while (child) { ee.removeChild(child); child = ee.lastElementChild; }*/
                    ...
                    return ( 
                        <li key = { list.title } > {console.log("li start")}
                            <div className = "listings-list-item" >
                                <NavLink to = {`/sagar/category/${list.category}/product/${list.id}`}>
                                <label> { last1 } </label> </NavLink>
                                {/*<div style = { myStyle } > {console.log("style")}
