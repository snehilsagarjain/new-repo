...
const Hp = (props) => {
    ...
    checkedState[i] = true;
    image.length = 0; title.length = 0;
    return ( 
                                        <> 
                                        {     
                                        props.data.map((list, index) => { 
                                                    return ( 
                                                        <li key = { list.title } > {console.log("li start1")}
                                                            <div className = "listings-list-item" > {console.log("div1")}
                                                                <NavLink to = {`/sagar/category/${list.category}/product/${list.id}`}> {console.log("navlink1")}
                                                                    <label> { list.title } </label> </NavLink>
                                                            </div> 
                                                        </li>
                                                    ); 
                                                })
    ...
    /*{/*<div style = { myStyle } > {console.log("style")}
                                ...
                                /*  <button key = { index } value = {last1} onClick = { () => { alert("Hello");
                                    ...
                                    return ( <Productdescriptionpage id = { id } title = { list.title } price = { price } 
                                        ...
                                        } }> { "Buy Now" } < /button> <br/ > </div> } *//* } </div> {console.log("buy")}*///}
...
/*                    {    /*data.map((list, index) => { 
                            ...
                            //if(list.category === newcate){
                                ...
                                return ( 
                                    {/*<li key = { index } >
                                        <div className = "listings-list-item" > {/* style = { myStyle } className = "bgimg" *//*}
                                            <div>                                                 {/*<div>*//*} 
...
{/*<li key = { index } > {console.log("li start1")}*/}{/* */}